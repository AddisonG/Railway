...
public class Section {
	...
	int length = 0;
	static String endPointA = "";
	static String endPointB = "";
	
	public static void main(String[] args) {
		endPointA = args[0];
		endPointB = args[1];
		Junction endPoint1 = new Junction(endPointA);
		// Junction endPoint1 = new Junction;
	}
	// MAIN
	...
	public Section(int length, JunctionBranch endPoint1, JunctionBranch endPoint2)
		...
		// if (JunctionBranch.equals(endPoint1)) {
	 ...
	 * "9 (j1, FACING) (j2, NORMAL)" or the string "9 (j2, NORMAL) (j1, FACING)"
	 * , would be valid string representations of a section of length 9, with
	 * end-points "(j1, FACING)" and "(j2, NORMAL)".
	 * </p>
	 */
	@Override
